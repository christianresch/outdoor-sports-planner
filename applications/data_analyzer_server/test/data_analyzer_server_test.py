...
mock_weather_aqi_analyzer_results_path = os.path.join(data_analyzers_dir, 'mock_weather_aqi_analyzer_results.pkl')
...
def test_RequestData_invalid():
    ...
    with pytest.raises(ValueError, match="Either 'city' or 'latitude/longitude' must be provided."):
        lat_data.validate()
